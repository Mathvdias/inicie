...
import '../views/task_list_page_test.mocks.dart';
...
void main() {
  ...
  testWidgets('should call addTask when saving a new task', (WidgetTester tester) async {
    when(mockTaskViewModel.addTask(
      any,
    ...
    await tester.enterText(find.byType(TextFormField).last, 'New Task Description');
    await tester.tap(find.text('Save'));
    await tester.pumpAndSettle();

    verify(mockTaskViewModel.addTask(
      'New Task Title',
      description: 'New Task Description',
    )).called(1);
  });

  testWidgets('should call updateTask when saving an existing task', (WidgetTester tester) async {
    final task = Task(id: '1', title: 'Test Task', description: 'Test Description');
    ...
    final updatedTask = task.copyWith(title: 'Updated Task Title', description: 'Updated Task Description');
